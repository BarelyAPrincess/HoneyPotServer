...
public class ConfigurationRemovedEvent extends ConfigurationEvent
{
	public ConfigurationRemovedEvent( String configurationId )
	{
	...
	{
		return EventTypesEnum.CONFIGURATION_REMOVED.getFullPathEventName();
	}
