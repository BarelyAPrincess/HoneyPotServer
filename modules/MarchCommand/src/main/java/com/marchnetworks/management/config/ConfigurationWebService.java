...
public class ConfigurationWebService
{
	...
	public DeviceImageDescriptor importImage( @WebParam( name = "deviceId" ) String devId, @WebParam( name = "name" ) String name, @WebParam( name = "description" ) String description ) throws ConfigurationException
	{
		try
		{
	...
	public DeviceImageDescriptor[] listAllImages() throws ConfigurationException
	{
		try
		{
	...
	public DeviceImageDescriptor getImage( @WebParam( name = "imageId" ) String imageId ) throws ConfigurationException
	{
		try
		{
	...
	public DeviceImageDescriptor editImage( @WebParam( name = "ImageId" ) String imageId, @WebParam( name = "name" ) String name, @WebParam( name = "description" ) String description ) throws ConfigurationException
	{
		try
		{
	...
	public DeviceImageDescriptor deleteImage( @WebParam( name = "imageId" ) String imageId ) throws ConfigurationException
	{
		try
		{
	...
	public void applyImages( @WebParam( name = "configurations" ) ConfigView[] configs ) throws ConfigurationException
	{
		try
		{
	...
	public DeviceImageState getDeviceImageStatus( @WebParam( name = "deviceId" ) String deviceId ) throws ConfigurationException
	{
		try
		{
	...
	public DeviceConfigDescriptor getDeviceConfig( @WebParam( name = "deviceConfigId" ) String deviceConfigId ) throws ConfigurationException
	{
		try
		{
