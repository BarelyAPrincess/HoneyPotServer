...
public interface HealthServiceIF
{
	AlertData[] getOpenAlerts( String paramString ) throws HealthFault;

	AlertData getAlertById( long paramLong ) throws HealthFault;

	void setUserState( long paramLong, AlertUserStateEnum paramAlertUserStateEnum ) throws HealthFault;

	void setUserStates( long[] paramArrayOfLong, AlertUserStateEnum paramAlertUserStateEnum ) throws HealthFault;
