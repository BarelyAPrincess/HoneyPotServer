...
public class Handler
{
	 ...
	 * @param callback The callback interface in which to handle messages, or null.
	 */
	public Handler( Looper looper, NoRtnFunction<Message> callback )
	{
	 ...
	 * @hide
	 */
	public Handler( Looper looper, NoRtnFunction<Message> callback, boolean async )
	{
		mLooper = looper;
	...
	{
		pw.println( prefix + this + " @ " + Kernel.uptime() );
		if ( mLooper == null )
	 ...
	 * <b>The time-base is {@link android.os.Kernel.uptimeLong}.</b>
	 * Time spent in deep sleep will add an additional delay to execution.
	 * The runnable will be run on the thread to which this handler is attached.
	 *
	 * @param r            The Runnable that will be executed.
	 * @param uptimeMillis The absolute time at which the callback should run,
	 *                     using the {@link android.os.Kernel.uptimeLong} time-base.
	 * @return Returns true if the Runnable was successfully placed in to the
	 * message queue.  Returns false on failure, usually because the
	 ...
	 * the looper is quit before the delivery time of the message
	 * occurs then the message will be dropped.
	 * @see android.os.Kernel.uptimeLong
	 */
	 ...
	 *                     delivered, using the
	 *                     {@link android.os.Kernel.uptimeLong} time-base.
	 * @return Returns true if the message was successfully placed in to the
	 * message queue.  Returns false on failure, usually because the
	 * looper processing the message queue is exiting.  Note that a
