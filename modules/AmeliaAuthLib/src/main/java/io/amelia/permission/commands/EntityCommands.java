...
public class EntityCommands extends PermissionBaseCommand
{
	...
	public void entityAddPermission( AccountAttachment sender, Map<String, String> args )
	{
		...
		entity.addPermission( args.get( "io/io.amelia/permission" ), true, refs );

		sender.sendMessage( EnumColor.WHITE + "Permission \"" + args.get( "io/io.amelia/permission" ) + "\" added!" );
	...
	public void entityAddTimedPermission( AccountAttachment sender, Map<String, String> args )
	{
		...
		String permission = args.get( "io/io.amelia/permission" );
		...
		PermissionDispatcher.getLogger().info( "User " + entityName + " get timed permission \"" + args.get( "io/io.amelia/permission" ) + "\" " + ( lifetime > 0 ? "for " + lifetime + " seconds " : " " ) + "from " + sender.getDisplayName() );
	}
	...
	public void entityCheckPermission( AccountAttachment sender, Map<String, String> args )
	{
		...
		String permission = entity.getMatchingExpression( args.get( "io/io.amelia/permission" ), refs );
	...
	public void entityRemovePermission( AccountAttachment sender, Map<String, String> args )
	{
		...
		String permission = autoCompletePermission( entity, args.get( "io/io.amelia/permission" ), refs );
	...
	public void entityRemoveTimedPermission( AccountAttachment sender, Map<String, String> args )
	{
		...
		entity.removeTimedPermission( args.get( "io/io.amelia/permission" ), refs );
	...
	public void entitySwapPermission( AccountAttachment sender, Map<String, String> args )
	{
		...
		try
		{
			int sourceIndex = getPosition( autoCompletePermission( entity, args.get( "io/io.amelia/permission" ), refs, "io/io.amelia/permission" ), permissions );
